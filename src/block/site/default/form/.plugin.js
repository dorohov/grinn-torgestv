...
var DEFAULTS = {
  ...
  template: '<div class="datepicker-container">' + '<div class="datepicker-panel" data-view="years picker">' + '<ul>' + '<li data-view="years prev"><span><svg class="icon-svg icon-icon-prev" role="img"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="'+CMS__TPL_PATH+'/img/svg/sprite.svg#icon-prev"></use></svg></span></li>' + '<li data-view="years current"></li>' + '<li data-view="years next"><span><svg class="icon-svg icon-icon-next" role="img"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="'+CMS__TPL_PATH+'/img/svg/sprite.svg#icon-next"></use></svg></span></li>' + '</ul>' + '<ul data-view="years"></ul>' + '</div>' + '<div class="datepicker-panel" data-view="months picker">' + '<ul>' + '<li data-view="year prev"><span><svg class="icon-svg icon-icon-prev" role="img"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="'+CMS__TPL_PATH+'/img/svg/sprite.svg#icon-prev"></use></svg></span></li>' + '<li data-view="year current"></li>' + '<li data-view="year next"><span><svg class="icon-svg icon-icon-next" role="img"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="'+CMS__TPL_PATH+'/img/svg/sprite.svg#icon-next"></use></svg></span></li>' + '</ul>' + '<ul data-view="months"></ul>' + '</div>' + '<div class="datepicker-panel" data-view="days picker">' + '<ul>' + '<li class="month prev" data-view="month prev"><span><svg class="icon-svg icon-icon-prev" role="img"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="'+CMS__TPL_PATH+'/img/svg/sprite.svg#icon-prev"></use></svg></span></li>' + '<li data-view="month current"></li>' + '<li class="month next" data-view="month next"><span><svg class="icon-svg icon-icon-next" role="img"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="'+CMS__TPL_PATH+'/img/svg/sprite.svg#icon-next"></use></svg></span></li>' + '</ul>' + '<ul data-view="week"></ul>' + '<ul data-view="days"></ul>' + '</div>' + '</div>',
